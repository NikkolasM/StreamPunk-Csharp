...
namespace StreamPunk.Threading.Thread.Windows
{
    public partial class Native
    {
        ...
        {
            if (suppliedAffinityMask <= 0UL) throw new ArgumentException("Supplied affinity mask needs atleast one element.");
    ...
    public class Affinity(ulong affinityMask) 
    {
        public readonly ulong affinityMask = affinityMask; // an arbitrarily long bitmask read from right to left
    }
    ...
    internal class DisposeStateMachine
    {
        ...
        public bool GetUsingStartAsync() { return Volatile.Read(ref this.UsingStartAsyncOnly); }
        public void SetUsingStartAsyncToTrue() { Volatile.Write(ref this.UsingStartAsyncOnly, true); }
    ...
    public class Thread<StartState>
    {
        ...
        private Affinity AppliedAffinity = new(0x0);
        ...
        public Task AwaitDisposalAsync(CancellationToken ct, decimal TimeoutMs = 0m)
        {
            return Task.Run(async () =>
            {
                ...
                decimal msToSeconds = TimeoutMs > 0m ? TimeoutMs / 1000m : 0m;
        ...
        public void CreateAndStartThread(StartState state, Action<StartState, ThreadAPIProxy<StartState>, CancellationToken> executionContext)
        {
            ...
            try
            {
                ...
                System.Threading.Thread DotnetThread = new((ThreadInstance) =>
                {
                    try
                    {
                ...
                // Recursive injection ensures proper visibility and accessibility of the Dotnet thread instance object from within 
                // the thread's execution context
                DotnetThread.Start(DotnetThread); this.ThrowIfShouldExit(ct);
